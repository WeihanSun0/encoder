...
if(ANDROID)
    ...
    if( CMAKE_CXX_COMPILER_ID STREQUAL "Clang" )
        set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -std=c++17 -fdeclspec -g -Wall -pthread")
...
elseif(CMAKE_HOST_SYSTEM_NAME STREQUAL "Linux")
    set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -std=c++17 -g -Wall -pthread")
    set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -g -pthread")
    set(CUDA_NVCC_FLAGS ${CUDA_NVCC_FLAGS} -std=c++17)
    ADD_DEFINITIONS(-D_ENV_LINUX)
elseif(CMAKE_HOST_SYSTEM_NAME STREQUAL "Darwin")
    ...
    set(CMAKE_CXX_FLAGS_RELEASE "${CMAKE_CXX_FLAGS_RELEASE} -std=c++17 -O2 -Wunused-function")
    set(CMAKE_C_FLAGS_RELEASE "${CMAKE_C_FLAGS} -std=c99 -O2 -pthread")
elseif(CMAKE_HOST_SYSTEM_NAME STREQUAL "Windows")
    ADD_DEFINITIONS(-D_ENV_WIN)
    # GNU GCC/G++ compilers
    if( CMAKE_CXX_COMPILER_ID STREQUAL "GNU" ) 
    message("compiler: gnu gcc compiler")
        set(CMAKE_CXX_FLAGS_DEBUG "${CMAKE_CXX_FLAGS_DEBUG} -std=c++17 -g -Wall -pthread")
        set(CMAKE_C_FLAGS_DEBUG "${CMAKE_C_FLAGS_DEBUG} -std=c99 -g -pthread")
        set(CMAKE_CXX_FLAGS_RELEASE "${CMAKE_CXX_FLAGS_RELEASE} -std=c++17 -O2 -pthread -Wunused-function")
